...
def main():
    ...
    print("This program will showcase all i have learned from my COP1500 class, HackerRank, and POGILS 1-5.")
    print()
    print("w = 2.01")
    print("x = 3")
    print("y = 2")
    ...
    print("They output a true or false depending on whether the statement is true or not.")
    print()
    x = 1
    y = 2
    print(x == x)
    ...
    print(y > x)
    print(x > y)
    print("The examples above are the greater-than operator, same as 2 > 1 and 1 > 2. one is true and the other false.")
    print()
    print()
    print("These next few examples are booleans." )
    print("Booleans are similar to conditionals but they are more restrictive, using AND, OR, and NOT.")
    print()
    A = 5
    B = 10
    C = 15
