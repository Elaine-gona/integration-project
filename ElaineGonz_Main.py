# """This integration project will showcase all that I have learned in this
# Spring semester of COP1500. The main sources I used were W3schools,
# Think Python 2e, and HackerRank. I was aided by Professor Vanselow and
# Rachel Matthews."""

__author__ = "Elaine Gonzalez"
...
def main():
    ...
    print(
        "This program will showcase all i have learned from my COP1500 class, "
    ...
    print()
    print(
        "This operator is called an exponentiation, it raises the x=3 to the "
        "y=2")
    print("x ** y")
    ...
    print(
        "This operator is called multiplication, it multiplies the x and y "
        "together.")
    print("x * y")
    # Line above is the formula"
    print(x * y)
    ...
    print()
    print(
        "The examples below show If, If-else, If-elif, and If-elif-else "
        "statements.")
    ...
    print()
    def salutation(word):
    """Salutation is saying goodbye to the user reading this program"""
        print(word)
    print()
    salutation("goodbye")
    print()
    print()
    print("Thank you for allowing me to show you what I have learned so far",
          end='.')
